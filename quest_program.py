while True: #Основной цикл для того, чтобы срабатывали концовки(break)
    ...
    x = 'магический жезл' #если в инвентаре есть жезл, то соответственный текст. если нету, то другой.(100 строка)
    ...
    if '1' in vibor1:
        vibor2 = input('Ты подошёл поближе и увидел портал. \n 1)Выйти из леса другой дорогой, рассказать родителям \n 2)Шагнуть в портал \n Ответ: ') #2 выбор
        if '1' in vibor2:
            ...
            if '3' in vibor4:
                ...
                if '2' in vibor5:
                    ...
                    if '2' in vibor6:
                        print('Пройдя дальше ты увидел старца. Убедившись, что он настоящий ты решил позадавать ему вопросы(ты можешь задавать их по несколько раз).')
                        while True: #позволяет задавать вопросы бесконечное количество раз, пока не будет введен нужный вариант(1) на 8 выборе
                            ...
                            if '2' in vibor7: #2 вопрос
                                print('-Я - волшебник. В нашем мире полно зла и оно уже пробралось и в ваш мир. Если допустить хоть малейшую ошибку, то мы все погибнем!')
                                vibor8 = input('-Поможешь нам? \n 1)Да! \n 2)Я постараюсь \n 3)Я не совсем понимаю о чём Вы... \n Ответ: ') #8 выбор
                                if '1' in vibor8 or '2' in vibor8:
                                    break #выход из цикла while и продолжение сюжета
                            if '3' in vibor7: #3 вопрос
                                print('-Нам кажется, что ты отлично подходишь под роль того, кто нам нужен. В свою очередь, мы - добрые волшебники, будем страться помогать тебе, но всё же прежде всего надейся только лишь на себя. Мы сами не знаем того, как победить зло.')
                                vibor8 = input('-Поможешь нам? \n 1)Да! \n 2)Я постараюсь \n 3)Я не совсем понимаю о чём Вы... \n Ответ: ') #8 выбор
                                if '1' in vibor8 or '2' in vibor8:
                                    break #выход из цикла while и продолжение сюжета
                            if '4' in vibor7: #4 вопрос
                                print('-Тебе нужно будет пробраться в пещеру дракона, КОТОРОГО НЕЛЬЗЯ ПОБЕДИТЬ С ПОМОЩЬЮ МАГИИ! Именно поэтому мы не можем с ним справиться и нам нужна твоя помощь.')
                                vibor8 = input('-Поможешь нам? \n 1)Да! \n 2)Я постараюсь \n 3)Я не совсем понимаю о чём Вы... \n Ответ: ') #8 выбор
                                if '1' in vibor8 or '2' in vibor8:
                                    break #выход из цикла while и продолжение сюжета
                        while True: #цикл. защита от обманщиков.
                            ...
                            if '2' in vibor9:
                                ...
                                if not invent:
                                    print('-Что же ты наделал! Быстро беги обратно, если он ещё на месте...')
                                    print('-Ты ведь не сможешь зайти в пещеру без кристалла!')
                                    print('Прибежав к порталу ты увидел, что кристалла нет. Обернувшись назад ты увидел ту самую старушку. Оказывается она не так доброжелательна, как тебе казалось...')
                                    print('Начни игру заново.')
                                ...
                                if not invent:
                                    print('Ах ты ж обманщик... Отвечай честно!')
                                if invent:
                                    print('-Это очень хорошо! Дай мне его и я сделаю тебе МАГИЧЕСКИЙ ЖЕЗЛ, который может тебе помочь.')
                        ...
                        if '1' in vibor10: #посох
                            print('-Вот и твой жезл, удачи!')
                            invent.remove('красный кристалл') #красный кристалл больше не в инвентаре
                            invent.append('магический жезл') #посох с красным кристаллом в инвентаре
                        if '2' in vibor10: #палка и верёвка
                            print('-Твоё решение... Может быть ты и прав, но на всякий случай возьми верёвку и палку - это всё, что у меня для тебя есть.')
                        ...
                        print('Зайдя в пещеру ты увидел огромного дракона, цвет кожи которого светился как красный кристалл.')
                        for i in invent: #проверяем есть ли посох в инвентаре
                            if i == x:
                                print('Так как твой кристалл ярко светился, а магический жезл ты держал в руках, ведь в карман его не положишь, дракон обернулся на неожиданный источник света и заметил тебя.')
                                vibor11 = input('Теперь у тебя всего два варианта: \n 1)Бросить магический жезл как копье \n 2)Воткнуть магический жезл в землю и надеяться на чудо... \n Ответ: ') #11 выбор
                                if '1' in vibor11:
                                    print('Была ни была... Ты решил кинуть магический жезл, но не учёл что кристалл не был заточен...')
                                    print('Дракон посмеялся над тобой и опалил пламенем...')
                                    print('Видимо надо быть внимательне...')
                                    print('Начни игру заново.')
                                    umer += 100
                                    break #выход из цикла
                                if '2' in vibor11:
                                    print('Ты воткнул магический жезл в землю, но... ничего не происходило...')
                                    print('Да, это волшебный лес, но если бы можно было сразиться с драконом волшебством - обошлись бы и без тебя.')
                                    print('Дракон посмеялся над тобой и опалил пламенем...')
                                    print('Видимо ты забыл о том, что говорил тот волшебник.')
                                    print('Ты начал вспоминать что же ты упустил... Вспомнил!!')
                                    print('"...пещеру дракона, КОТОРОГО НЕЛЬЗЯ ПОБЕДИТЬ С ПОМОЩЬЮ МАГИИ! Именно поэтому мы не можем с ним справиться..."')
                                    print('Начни игру заново.')
                                    umer += 100
                                    break #выход из цикла
                        if umer == 100:
